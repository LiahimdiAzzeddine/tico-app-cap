...
function Intro0() {
  return (
    <div className="flex flex-col items-center justify-between bg-white min-h-screen w-full bg-no-repeat intro0 max-w-sm m-auto" style={{paddingTop:"env(safe-area-inset-top)" }}>
      {/* Logo Section */}
      ...
      <div className="grow flex items-center justify-center w-full max-w-sm px-2">
        <div className="w-full aspect-square flex items-start justify-center relative">
          <div className="flex flex-col items-center justify-center w-4/6 text-center space-y-10 min-h-[65%]">
