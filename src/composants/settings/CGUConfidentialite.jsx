      ...
      <div className="max-w-3xl mx-auto px-2">
        ...
        <section className="mb-8">
          <div className="text-gray-700 leading-relaxed mb-4">
            ...
            <p className="mb-4">
              ...
              <a href="mailto:contact@foodhea.com" className="text-custom-blue">
                contact@foodhea.com
              </a>
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              sur les principales plateformes de distribution (App Store et
              Google Play).
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              L’éditeur s’engage à mettre à jour régulièrement l’application
              pour garantir son bon fonctionnement et son accessibilité. Il
              veille à fournir des informations objectives et complètes, mais ne
              peut être tenu responsable des erreurs ou omissions. L’utilisation
              de l’application à des fins frauduleuses ou illégales est
              strictement interdite, et toute violation des conditions
              d’utilisation pourra entraîner la suspension ou la suppression de
              l’accès à l’application.
            </p>
            <p className="mb-4">
              L’utilisateur a la possibilité de soumettre ses propres recettes
              via l’application. Chaque recette soumise sera vérifiée par TiCO
              pour s’assurer qu’elle respecte les critères de l’application
              avant d’être publiée. Dans le cas contraire, la recette pourrait
              ne pas être publiée. En soumettant une recette, l’utilisateur
              garantit être le créateur original du contenu et accorde à TiCO
              une licence non exclusive pour l’utiliser dans le cadre de ses
              services.
            </p>
            <p className="mb-4">
              ...
              solliciter une marque directement depuis le produit de son choix
              en utilisant un curseur dédié. Les demandes recueillies sont
              ensuite regroupées, et dès qu’un nombre suffisant de
              sollicitations est atteint, TiCO contacte la marque concernée pour
              l’encourager à rendre ses informations plus accessibles.
            </p>
            <p className="mb-4">
              Les données de base relatives aux produits alimentaires présentes
              dans l’application proviennent de sources ouvertes, telles qu’Open
              Food Facts. Ces données sont complétées. avec les marques puis
              décryptées et validées indépendamment par notre équipe. TiCO
              s’assure de la qualité et de la précision des informations
              fournies après vérifications des données, mais ne peut être tenu
              responsable des erreurs ou omissions provenant de ces sources.
            </p>
            <h3 className="text-lg font-semibold text-custom-blue mb-4">
            ...
            <p className="mb-4">
              ...
              s’engage à informer immédiatement l’éditeur. Toute activité
              réalisée à partir d’un compte utilisateur est de la responsabilité
              de l’utilisateur.
            </p>
            <h3 className="text-lg font-semibold text-custom-blue mb-4">
            ...
            <p className="mb-4">
              TiCO s’engage à respecter la confidentialité des données
              personnelles des utilisateurs et à les traiter conformément au
              Règlement Général sur la Protection des Données (RGPD). Les
              données sont collectées uniquement pour les besoins de
              l’application et ne sont partagées avec des tiers qu’avec le
              consentement explicite des utilisateurs.
            </p>
            <p className="mb-4">
              L’utilisateur dispose de droits d’accès, de rectification, de
              suppression et d’opposition sur ses données, qu’il pourra exercer
              en contactant notre service dédié à la protection des données (
              <a
                href="mailto:dpo@foodhea.com"
              ...
              ), au sujet du traitement des données à caractère personnel par
              TiCO.
            </p>
            <h3 className="text-lg font-semibold text-custom-blue mb-4">
        ...
        9. Mise à jour des CGU
          ...
          <p className="mb-4">
            ...
            <a
              href="mailto:contact@foodhea.com"
              className="text-custom-blue underline"
            >
              contact@foodhea.com
            </a>
