    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            <div
              className="relative w-full h-full aspect-square flex items-center justify-center bg-no-repeat bg-contain bg-center"
              style={{
        ...
        <div className="flex flex-col items-center justify-center w-full space-y-2">
          ...
          {loading ? (
            ...
            <>
              ...
              <textarea
                className="w-full min-h-20 min-w-60 rounded-xl border resize-none"
    ...
    return (
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
        <div className="flex flex-col items-center justify-center w-full space-y-4">
          ...
          {/* Voir Plus Link */}
          <a href="#" className="text-custom-blue underline mt-4 italic">Voir plus</a>
        </div>
      </Modal>
    );
  };