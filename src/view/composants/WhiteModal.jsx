...
const WhiteModal = ({ isOpen, onClose, children }) => {
  return (
    <IonModal
      isOpen={isOpen}
    ...
    >
      {/* Custom Header */}
      <div className="flex justify-between items-center mb-5 mt-1 mx-1 p-4 modal-background">
        <button className="text-[#006aff]" onClick={onClose}>
          <img src={Return} alt="Close" className="w-10 h-10" />
        </button>
